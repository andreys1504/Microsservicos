...
public sealed class ConsumerCommandsOnCatalogo : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly EnvironmentSettings _environmentSettings;
    private IConsumerCommandRabbitMq _consumerCommandRabbitMq;

    public ConsumerCommandsOnCatalogo(
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        await _consumerCommandRabbitMq.ConsumerCommandAsync(
            queueName: nameof(Contexts.Catalogo) + _environmentSettings.MessageBroker.DefaultConfigs.Commands.Queue,
