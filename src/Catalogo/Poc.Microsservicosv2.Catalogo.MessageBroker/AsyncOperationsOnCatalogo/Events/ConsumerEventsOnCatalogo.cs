...
public sealed class ConsumerEventsOnCatalogo : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly EnvironmentSettings _environmentSettings;
    private IConsumerEventRabbitMq _consumerEventRabbitMq;

    public ConsumerEventsOnCatalogo(
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        await _consumerEventRabbitMq.ConsumerEventAsync(
            queueName: nameof(Contexts.Catalogo) + _environmentSettings.MessageBroker.DefaultConfigs.Events.Queue,
