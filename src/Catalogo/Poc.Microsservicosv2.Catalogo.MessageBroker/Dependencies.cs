...
namespace Poc.Microsservicosv2.Catalogo.MessageBroker;
...
public static class Dependencies
{
    public static void Register(IServiceCollection services, EnvironmentSettings environmentSettings)
    {
        ...
        AsyncOperationsOnCatalogo.Dependencies.Register(services, connection, environmentSettings, publishersSetup, consumersSetup);
