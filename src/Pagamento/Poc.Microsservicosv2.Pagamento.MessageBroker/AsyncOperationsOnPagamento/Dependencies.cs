...
using Poc.Microsservicosv2.Pagamento.MessageBroker.AsyncOperationsOnPagamento.Commands;
using Poc.Microsservicosv2.Pagamento.MessageBroker.AsyncOperationsOnPagamento.Events;
using RabbitMQ.Client;

namespace Poc.Microsservicosv2.Pagamento.MessageBroker.AsyncOperationsOnPagamento;
...
public static class Dependencies
{
    ...
    {
        //ConsumersCommands
        services.AddHostedService<ConsumerCommandsOnPagamento>();

        //ConsumersEvents
        services.AddHostedService<ConsumerEventsOnPagamento>();
    }
}
