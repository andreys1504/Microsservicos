...
namespace Poc.Microsservicosv2.Pagamento.MessageBroker.IntegrationEventsContexts;
...
public static class ConsumersConfig
{
    public static IEnumerable<ConsumerSetup> Register(IConnection connectionRabbitMq, EnvironmentSettings environmentSettings)
    {
        ...
        foreach (MappingEventContextOrigin consumer in Pegamento.Application.MessageBroker.IntegrationEventsContexts.IntegrationEventsConsumersConfig.Mappings(environmentSettings))
        {
