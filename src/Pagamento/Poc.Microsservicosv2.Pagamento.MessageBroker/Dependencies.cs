...
namespace Poc.Microsservicosv2.Pagamento.MessageBroker;
...
public static class Dependencies
{
    public static void Register(IServiceCollection services, EnvironmentSettings environmentSettings)
    {
        ...
        AsyncOperationsOnPagamento.Dependencies.Register(services, connection, environmentSettings, publishersSetup, consumersSetup);
